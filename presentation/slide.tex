...
%   \SubItem{ước lượng số lượng $n$ bằng cách quan sát số lượng lớn nhất 
%   của các số không dấu trong biểu diễn nhị phân}
...
% \begin{frame}{LogLog algorithm}
% \begin{itemize}
%   \item Giả sử chúng ta cần đếm định lượng cho đến $2^{30}$, tức là 
%   khoảng 1 tỷ, với độ chính xác khoảng 4\%. Như đã đề cập, cho sai số tiêu chuẩn như vậy, 
