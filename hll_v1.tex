...
\begin{center}
    ...
    \begin{tabular}{ |c|c|l| }
        ...
        \hline
        3 & 5 - 6 &\vtop{\hbox{\strut Hiện thực bài toán mở rộng để ước lượng số lượng phần tử trong một khoảng thời gian trên nhiều dòng dữ liệu.}\hbox{\strut Đánh giá hiệu suất và độ chính xác.}}\\
        \hline
