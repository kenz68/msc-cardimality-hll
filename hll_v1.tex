...
\begin{center}
    ...
    \begin{tabular}{ |c|c|l| }
        ...
        \hline
        3 & 5 - 6 &\vtop{\hbox{\strut Hiện thực 2 bài toán mở rộng trên nhiều dòng dữ liệu và các khung thời gian khác nhau.}\hbox{\strut Đánh giá hiệu suất và độ chính xác.}}\\
        \hline
...
\textbf{Chương 3: Hiện thực và thử nghiệm thuật toán. } Trong chương này sẽ trình bày chi tiết cách thức hiện thực của từng thuật toán. \\

\textbf{Chương 4: Kết quả và đánh giá.} Trong chương này sẽ nêu ra các kết quả đạt được của các kỹ thuật, cũng như phương pháp đánh giá 
dựa trên kết quả thực nghiệm.\\

\textbf{Chương 5: Kết luận.} Trong chương này sẽ tóm lại các ưu điểm và nhược điểm của mô hình và đưa ra các hướng nghiên cứu phát triển 
